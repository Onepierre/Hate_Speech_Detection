...
def convert_roberta_checkpoint_to_pytorch(
    ...
    config = RobertaConfig(
        ...
        hidden_size=roberta.model.encoder.args.encoder_embed_dim,
        num_hidden_layers=roberta.model.encoder.args.encoder_layers,
        num_attention_heads=roberta.model.encoder.args.encoder_attention_heads,
        intermediate_size=roberta.model.encoder.args.encoder_ffn_embed_dim,
